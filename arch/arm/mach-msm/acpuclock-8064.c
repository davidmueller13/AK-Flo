...
static struct acpu_level tbl_PVS0_1512MHz[] __initdata = {
	...
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
#endif
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(L2_BW_MID),   950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(L2_BW_MID),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_HIGH),  962500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_HIGH), 1000000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_HIGH), 1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_HIGH), 1037500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(L2_BW_HIGH), 1075000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(L2_BW_HIGH), 1087500 },
...
static struct acpu_level tbl_PVS1_1512MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_HIGH), 1012500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(L2_BW_HIGH), 1037500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(L2_BW_HIGH), 1050000 },
...
static struct acpu_level tbl_PVS2_1512MHz[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(L2_BW_MID),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_HIGH),  925000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_HIGH),  937500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_HIGH),  950000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_HIGH),  975000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(L2_BW_HIGH), 1000000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(L2_BW_HIGH), 1012500 },
...
static struct acpu_level tbl_PVS3_1512MHz[] __initdata = {
	...
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000 },
#endif
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(L2_BW_MID),   900000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(L2_BW_MID),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_HIGH),  900000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_HIGH),  900000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_HIGH),  925000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_HIGH),  950000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(L2_BW_HIGH),  975000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(L2_BW_HIGH),  987500 },
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(L2_BW_MID),   875000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_HIGH),  875000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_HIGH),  887500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_HIGH),  900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_HIGH),  925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(L2_BW_HIGH),  950000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(L2_BW_HIGH),  962500 },
...
static struct acpu_level tbl_PVS5_1512MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_HIGH),  900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_HIGH),  925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(L2_BW_HIGH),  937500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(L2_BW_HIGH),  950000 },
