...
static struct acpu_level tbl_PVS0_1512MHz[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(14),  962500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(14), 1000000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(14), 1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(14), 1037500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1075000 },
...
static struct acpu_level tbl_PVS1_1512MHz[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(14),  962500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(14),  975000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(14), 1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(14), 1012500 },
...
static struct acpu_level tbl_PVS2_1512MHz[] __initdata = {
	...
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(14),  937500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(14),  950000 },
...
static struct acpu_level tbl_PVS3_1512MHz[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(14),  900000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(14),  900000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(14),  925000 },
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	...
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(14),  887500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(14),  900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(14),  925000 },
